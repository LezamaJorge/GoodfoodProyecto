                                              ...
                                              child: IconButton(
                                                onPressed: () {
                                                  ...
                                                  showDialog(
                                                      ...
                                                      builder: (context) => CustomDialog(
                                                            controller: controller,
                                                            title: "Delivery Boy Statement Download",
                                                            widgetList: [
                                                              const TextCustom(
                                                                title: 'Select Time',
                                                                fontFamily: FontFamily.regular,
                                    ...
                                    : controller.currentPageDriver.isEmpty
                                        ...
                                        : DataTable(
                                            ...
                                            columns: [
                                              ...
                                              CommonUI.dataColumnWidget(context, columnTitle: "Status".tr, width: ResponsiveWidget.isMobile(context) ? 150 : MediaQuery.of(context).size.width * 0.06),
                                              CommonUI.dataColumnWidget(context,
                                                  columnTitle: "Created Date".tr, width: ResponsiveWidget.isMobile(context) ? 150 : MediaQuery.of(context).size.width * 0.08),
                                              CommonUI.dataColumnWidget(context, columnTitle: "Actions".tr, width: ResponsiveWidget.isMobile(context) ? 150 : MediaQuery.of(context).size.width * 0.08),
                                            ],
                                            rows: controller.currentPageDriver
                                                .map((driverModel) => DataRow(cells: [
                                                      ...
                                                      DataCell(TextCustom(
                                                        title: Constant.maskMobileNumber(countryCode: driverModel.countryCode.toString(), mobileNumber: driverModel.phoneNumber.toString()),
                                                      )),
                                                      DataCell(TextCustom(title: driverModel.driverVehicleDetails!.vehicleTypeName == "bike" ? "Bike" : "Scooter")),
                                                      DataCell(TextCustom(
                                                        title: driverModel.isVerified == true ? "Verified" : "Not Verified",
        ...
        widgetList: [
          Row(
            children: [
              ...
              spaceW(width: 8),
              const TextCustom(title: "Personal Info", fontSize: 16, fontFamily: FontFamily.medium),
            ],
          ),
          spaceH(height: 24),
          // profile image
          ...
          Row(
            children: [
              ...
              spaceW(width: 8),
              const TextCustom(title: "Vehicle Information", fontSize: 16, fontFamily: FontFamily.medium),
            ],
          ),
          spaceH(height: 16),
          (ResponsiveWidget.isDesktop(context) || ResponsiveWidget.isTablet(context))
          ...
          Row(
            children: [
              ...
              spaceW(width: 8),
              const TextCustom(title: "Upload Document", fontSize: 16, fontFamily: FontFamily.medium),
            ],
          ),
          spaceH(height: 24),
          ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              String title = index < controller.documentsList.length ? controller.documentsList[index].name ?? "Unknown Document" : "Unknown Document";
            ...
            onPress: () {
              if (Constant.isDemo) {
                ...
                if (controller.firstNameController.value.text.isEmpty) {
                  ...
                  ShowToastDialog.errorToast("Please Add Driving License..");
                  ...
                  ShowToastDialog.errorToast("Please Select Vehicle Type..");
                } else if (controller.vehicleModelController.value.text.isEmpty) {
                  ShowToastDialog.errorToast("Please Enter Vehicle Model..");
                } else if (controller.vehicleNumberController.value.text.isEmpty) {
                  ShowToastDialog.errorToast("Please Enter Vehicle Number");
                } else if (areImagesUploaded == false) {
                  ShowToastDialog.errorToast("Please Upload Document..");
                } else {
                  Navigator.pop(context);
