...
class DriverCancellingReasonController extends GetxController{
  ...
  Future<void> removeReason(String reason) async {
    ...
    await FirebaseFirestore.instance.collection(CollectionName.settings).doc("driver_reject_reason").set(<String, List<String>>{"reasons": driverCancellingReasonList}).then((value) {
