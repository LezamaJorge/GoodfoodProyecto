                                ...
                                child: controller.isLoading.value
                                    ...
                                    : controller.currentPageUser.isEmpty
                                        ...
                                        : DataTable(
                                            ...
                                            columns: [
                                              CommonUI.dataColumnWidget(context, columnTitle: "Image".tr, width: ResponsiveWidget.isMobile(context) ? 150 : MediaQuery.of(context).size.width * 0.08),
                                              ...
                                              CommonUI.dataColumnWidget(context, columnTitle: "Status".tr, width: ResponsiveWidget.isMobile(context) ? 100 : MediaQuery.of(context).size.width * 0.05),
                                      ...
                                      CustomButtonWidget(
                                        ...
                                        onPress: () {
                                          if (controller.optionNameController.value.text.isEmpty) {
                                            ShowToastDialog.errorToast('Please enter an option name.');
                                          } else if (controller.optionPriceController.value.text.isEmpty) {
                                            ShowToastDialog.errorToast('Please enter an option price.');
                                          } else {
                  ...
                  onPress: () {
                    if (Constant.isDemo) {
                      ...
                      if (controller.itemNameController.value.text.isNotEmpty &&
                        ...
                        ShowToastDialog.errorToast("Please provide valid input.");
                      }
                    }
                  },
                ),
