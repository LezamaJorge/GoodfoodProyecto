                                                ...
                                                onPressed: () {
                                                  ...
                                                  showDialog(
                                                      ...
                                                      builder: (context) => CustomDialog(
                                                            controller: controller,
                                                            title: "Owner Statement Download",
                                                            widgetList: [
                                                              const TextCustom(
                                                                title: 'Select Time',
                                                                fontFamily: FontFamily.regular,
                            ...
                            SingleChildScrollView(
                              ...
                              child: ClipRRect(
                                  ...
                                  child: controller.isLoading.value
                                      ...
                                      : controller.currentPageOwnerList.isEmpty
                                          ...
                                          : DataTable(
                                              ...
                                              columns: [
                                                ...
                                                CommonUI.dataColumnWidget(context, columnTitle: "Email".tr, width: ResponsiveWidget.isMobile(context) ? 150 : MediaQuery.of(context).size.width * 0.12),
                                                ...
                                                CommonUI.dataColumnWidget(context,
                                                    columnTitle: "Document Verify".tr, width: ResponsiveWidget.isMobile(context) ? 100 : MediaQuery.of(context).size.width * 0.04),
                                              ...
                                              rows: controller.currentPageOwnerList
                                                  .map((ownerModel) => DataRow(cells: [
                                                        ...
                                                        DataCell(TextCustom(
                                                          title: Constant.maskMobileNumber(countryCode: ownerModel.countryCode.toString(), mobileNumber: ownerModel.phoneNumber.toString()),
                                                        )),
