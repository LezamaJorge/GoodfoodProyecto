...
class CartModel {
  ...
  @override
  String toString() {
    return 'CartModel{id: $id, productId: $productId, customerId: $customerId, quantity: $quantity, itemPrice: $itemPrice, totalAmount: $totalAmount, productName: $productName, addOns: $addOns, variation: $variation, vendorId: $vendorId}';
  }
