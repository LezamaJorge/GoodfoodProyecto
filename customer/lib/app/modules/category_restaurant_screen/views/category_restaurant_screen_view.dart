...
import 'package:customer/app/modules/category_restaurant_screen/controllers/category_restaurant_screen_controller.dart';
...
class CategoryRestaurantScreenView extends GetView<AllRestaurantScreenController> {
  const CategoryRestaurantScreenView({super.key});

  @override
  Widget build(BuildContext context) {
    final themeChange = Provider.of<DarkThemeProvider>(context);
    return GetX<CategoryRestaurantScreenController>(
        init: CategoryRestaurantScreenController(),
        builder: (controller) {
          return Container(
                        ...
                        () => Padding(
                          ...
                          child: RefreshIndicator(
                            ...
                            child: controller.isLoading.value
                                ? Constant.loader()
                                : (controller.selectedType.value == 0 && controller.allRestaurantList.isEmpty) ||
                                        (controller.selectedType.value == 1 && controller.vegRestaurantList.isEmpty) ||
                                        (controller.selectedType.value == 2 && controller.nonVegRestaurantList.isEmpty) ||
                                        (controller.selectedType.value == 3 && controller.top5RestaurantList.isEmpty)
                                    ? const Center(
                                        ...
                                        itemCount: controller.selectedType.value == 0
                                            ...
                                            : controller.selectedType.value == 1
                                                ...
                                                : controller.selectedType.value == 2
                                                    ...
                                                    : controller.top5RestaurantList.length,
                                          ...
                                          VendorModel restaurant = controller.selectedType.value == 0
                                              ...
                                              : controller.selectedType.value == 1
                                                  ...
                                                  : controller.selectedType.value == 2
                                                      ...
                                                      : controller.top5RestaurantList[index];
