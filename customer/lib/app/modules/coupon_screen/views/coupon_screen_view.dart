                      ...
                      Expanded(
                        ...
                        child: Padding(
                          ...
                          child: RoundShapeButton(
                              title: "Apply".tr, buttonColor: AppThemeData.orange300, buttonTextColor: AppThemeData.primaryWhite,
                              onTap: () async {
                                                  ...
                                                  GestureDetector(
                                                    onTap: () {
                                                      ...
                                                      if (double.parse(cartController.calculateItemTotal().toString()) < double.parse(couponModel.minAmount.toString())) {
                                                        ShowToastDialog.showToast("Minimum amount ${Constant.amountShow(amount: couponModel.minAmount)} required".tr);
                                                        return;
                                                      }
