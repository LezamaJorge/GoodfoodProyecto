                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                        border: OutlineInputBorder(
                            borderRadius: BorderRadius.circular(12), borderSide: BorderSide(color: themeChange.isDarkTheme() ? AppThemeData.grey600 : AppThemeData.grey400)),
              ...
              onTap: () async {
                ...
                await FireStoreUtils.getDriverUserProfile(controller.bookingModel.value.driverId.toString()).then((value) async {
                  if (value != null) {
                    ...
                    if (controller.reviewModel.value.id != null) {
                      driverModel.reviewSum =
                          (double.parse(driverModel.reviewSum.toString()) - double.parse(controller.reviewModel.value.rating.toString())).toString();
                ...
                await FireStoreUtils.setReview(controller.reviewModel.value).then((value) {
                  if (value == true) {
                    ...
                    Get.back();
                    // Get.toNamed(Routes.ORDER_DETAIL_SCREEN);
                  }
                });
              },
