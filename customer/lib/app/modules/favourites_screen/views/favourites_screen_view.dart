                                                        ...
                                                        ? Row(
                                                            children: [
                                                              Container(
                                                                ...
                                                                decoration:
                                                                    BoxDecoration(borderRadius: BorderRadius.circular(12), border: Border.all(color: AppThemeData.orange300)),
                                                                child: Row(
                                                                  children: [
                                                                    InkWell(
                                                                      onTap: () {
                                                                    ...
                                                                    InkWell(
                                                                      onTap: () {
                                                                        if (int.parse(cartModel.quantity.toString()) >= int.parse(product.maxQuantity.toString())) {
                                                                          ShowToastDialog.showToast("You’ve reached the maximum quantity allowed  ${product.maxQuantity}".tr);
                                                                        } else {
                                                                          controller.updateQuantity(cartModel, cartModel.quantity! + 1);
                                                                          controller.favouriteDishesList.refresh();
                                                                        }
                                                                ...
                                                                if (product.variationList!.isEmpty && product.addonsList!.isEmpty) {
                                                                  ...
                                                                  if (controller.cartItemsList.isEmpty) {
                                                                    controller.cartDatabaseHelper.insertCartItem(cartModel).then((value) {
                                                                      ...
                                                                      ShowToastDialog.showToast("Failed to add item to cart");
                                                                    });
                                                                  } else {
                                                                              ...
                                                                              if (isSameRestaurant) {
                                                                                ...
                                                                                showDialog(
                                                                                    ...
                                                                                    builder: (BuildContext context) {
                                                                                      return AlertDialog(
                                                                                        backgroundColor:
                                                                                            themeChange.isDarkTheme() ? AppThemeData.primaryBlack : AppThemeData.primaryWhite,
                                                                                        title: Column(
                                                                                          children: [
                                                                                            TextCustom(
                                                                                              title: "Replace Cart Item ? ".tr,
                                                                                              ...
                                                                                              children: [
                                                                                                Expanded(
                                                                                                  child: RoundShapeButton(
                                                                                                      title: "Cancel".tr,
                                                                                                      buttonColor:
                                                                                                          themeChange.isDarkTheme() ? AppThemeData.grey700 : AppThemeData.grey300,
                                                                                                      buttonTextColor:
                                                                                                          themeChange.isDarkTheme() ? AppThemeData.grey50 : AppThemeData.grey1000,
                                                                                                      onTap: () {
                                                                                                        Navigator.pop(context);
                  ...
                  children: [
                    ...
                    InkWell(
                      onTap: () {
                        if (favouritesScreenController.quantity.value >= int.parse(productModel.maxQuantity.toString())) {
                          ShowToastDialog.showToast("you can only add ${productModel.maxQuantity} Items..".tr);
                        } else {
                          favouritesScreenController.quantity.value++;
                        }
                      },
                    ...
                    RoundShapeButton(
                        title: isEditing == true
                            ? "Edit Item | ${Constant.amountShow(amount: favouritesScreenController.calculateItemTotal(productModel: productModel).toString())}".tr
                            : "Add Item | ${Constant.amountShow(amount: favouritesScreenController.calculateItemTotal(productModel: productModel).toString())}".tr,
                        buttonColor: AppThemeData.orange300,
                        buttonTextColor: AppThemeData.primaryWhite,
