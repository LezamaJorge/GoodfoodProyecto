...
class HomeView extends GetView<HomeController> {
  ...
  Widget build(BuildContext context) {
    ...
    return GetX<HomeController>(
      init: HomeController(),
      builder: (controller) {
        final int halfLength = (controller.categoryList.length / 2).ceil();
        final firstHalf = controller.categoryList.sublist(0, halfLength);
        final secondHalf = controller.categoryList.sublist(halfLength);
        return Container(
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              InkWell(
                                onTap: () {
                                  Get.to(const CategoryScreenView());
                                },
                                child: TextCustom(
                                  title: "View all".tr,
                                  fontSize: 16,
                                    ...
                                    children: [
                                      SizedBox(
                                        ...
                                        child: ListView.builder(
                                          ...
                                          itemBuilder: (context, index) {
                                            CategoryModel categoryModel = firstHalf[index];
                                            return GestureDetector(
                                              onTap: () {
                                                Get.to(const CategoryRestaurantScreenView(), arguments: {"categoryModel": categoryModel});
                                              },
                                              child: CategoryItem(
                                                category: firstHalf[index],
                                      ...
                                      SizedBox(
                                        ...
                                        child: ListView.builder(
                                          ...
                                          itemBuilder: (context, index) {
                                            CategoryModel categoryModel = secondHalf[index];
                                            return GestureDetector(
                                              onTap: () {
                                                Get.to(const CategoryRestaurantScreenView(), arguments: {"categoryModel": categoryModel});
                                              },
                                              child: CategoryItem(
                                                category: secondHalf[index],
                                                themeChange: themeChange,
                                              ),
                                            );
                                          },
                                      ...
                                      return restaurant.isOnline == true
                                          ? GestureDetector(
                                              ...
                                              child: Container(
                                                ...
                                                width: 229.w,
                                                decoration: BoxDecoration(
                                                    color: themeChange.isDarkTheme() ? AppThemeData.grey900 : AppThemeData.grey100, borderRadius: BorderRadius.circular(12)),
                                                child: Column(
                                                  children: [
                                                    ClipRRect(
                    ...
                    Container(
                        ...
                        decoration: BoxDecoration(
                            gradient: LinearGradient(
                                ...
                                colors: themeChange.isDarkTheme() ? [const Color(0xff1B1B21), const Color(0xff1A0B00)] : [const Color(0xffFFFFFF), const Color(0xffFFF1E5)])),
                        child: TextCustom(
      ...
      child: controller.bannerList.isEmpty
          ...
          : ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                Color backgroundColor = controller.colors[index % controller.colors.length];
                String svgPath = controller.svgPaths[index % controller.svgPaths.length];
                return Padding(
                      ...
                      Stack(
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              TextCustom(
                                title: bannerModel.bannerName.toString(),
                                fontSize: 18,
                                fontFamily: FontFamily.bold,
                                color: backgroundColor,
                              ),
                              TextCustom(
                                title: (bannerModel.offerText == null || bannerModel.offerText!.isEmpty) ? '' : bannerModel.offerText.toString(),
                                fontSize: 12,
                                fontFamily: FontFamily.light,
                                color: backgroundColor,
                              ),
