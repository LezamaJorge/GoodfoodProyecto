                ...
                gradient: index == 0
                    ? LinearGradient(
                        colors: themeChange.isDarkTheme()
                            ? [const Color(0xff1A0B00), const Color(0xff09090B)]
                            : [const Color(0xffFFF1E5), const Color(0xffFAFAFA)],
                    ...
                    : index == 1
                        ...
                        : index == 2
                            ...
                            : const LinearGradient(
                                colors: [Color(0xffFDE7E7), Color(0xffFAFAFA)], begin: Alignment.topCenter, end: Alignment.bottomCenter)),
            child: Column(
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      //   text: TextSpan(
                      //     text: titleParts[0],
                      //     style: TextStyle(fontSize: 28, fontFamily: FontFamily.bold, color: themeChange.isDarkTheme() ? AppThemeData.grey50 : AppThemeData.grey1000),
                      //     children: [
                      //       TextSpan(text: " ${titleParts[1]}", style: TextStyle(fontSize: 28, fontFamily: FontFamily.bold, color: textColor)),
                      //     ],
                      //   ),
                      // ),
