                  ...
                  child: Column(
                    ...
                    children: [
                      Padding(
                          ...
                          child: buildTopWidget(context, "My Cart".tr, "Review your selections and customize your order before completing your purchase.".tr)),
                      spaceH(height: 32),
                      controller.isLoading.value
                          ? Constant.loader()
                          : (controller.cartItems.isEmpty)
                              ? Constant.showEmptyView(context, message: "Your Cart is Empty".tr)
                              : Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Padding(
                                                  ...
                                                  return Column(
                                                    ...
                                                    children: [
                                                      Row(
                                                        children: [
                                                          FutureBuilder(
                                                              future: FireStoreUtils.getProductByProductId(cartModel.productId.toString()),
                                                          ...
                                                          Expanded(
                                                            child: TextCustom(
                                                              title: cartModel.productName.toString(),
                                                              fontSize: 16,
                                                      ...
                                                      if (cartModel.variation != null &&
                                                          cartModel.variation!.name?.trim().isNotEmpty == true &&
                                                          (cartModel.variation!.optionList?.isNotEmpty ?? false))
                                                        Row(
                                                          children: [
                                                            TextCustom(
                                                              title: "${cartModel.variation!.name.toString().trim()}: ",
                                                              fontSize: 14,
                                                      ...
                                                      Row(
                                                        children: [
                                                          ...
                                                          InkWell(
                                                            onTap: () {
                                                              if (int.parse(cartModel.quantity.toString()) >= 5) {
                                                                ShowToastDialog.showToast("you can only add 5 Items..".tr);
                                                              } else {
                                                                controller.updateQuantity(cartModel, cartModel.quantity! + 1);
                                                              }
                                                            },
                                                          ...
                                                          if (cartModel.variation != null)
                                                            GestureDetector(
                                                              onTap: () async {
                                                                ProductModel? product = await FireStoreUtils.getProductByProductId(cartModel.productId.toString());
                                                                if (product != null) {
                                                                  showModalBottomSheet(
                                                                      ...
                                                                      builder: (context) {
                                                                        return AddonsBottomSheet(
                                                                          ...
                                                                          detailController: restaurantDetailController,
                                                                          cartModel: cartModel,
                                                                          isEditing: true,
                                                                          onTap: () async {
                                                                            CartModel cartModel = CartModel(
                                                                              ...
                                                                              variation: VariationModel(
                                                                                ...
                                                                                optionList: [restaurantDetailController.selectedOption.value],
                                                                  ...
                                                                  ShowToastDialog.showToast("Product details unavailable.".tr);
                                                                }
                                                              },
                                    ...
                                    Padding(
                                      ...
                                      child: TextFieldWidget(
                                        ...
                                        controller: controller.cookingInstruction.value,
                                        onPress: () {},
                                        hintText: '',
                                      ),
                                    ),
                                                          ...
                                                          children: [
                                                                ...
                                                                GestureDetector(
                                                                  onTap: () async {
                                                                    CartModel cartModel = CartModel(
                                                                      ...
                                                                      itemPrice: productModel.price.toInt(),
                                                                      totalAmount: productModel.price.toInt() * 1,
                                                                      quantity: 1,
                                                                    );

                                                                    bool isItemInCart =
                                                                        await restaurantDetailController.cartDatabaseHelper.isItemInCart(cartModel.productId.toString());
                                                                    if (isItemInCart) {
                                                                      ShowToastDialog.showToast("This item is already in your cart.".tr);
                                                                      return;
                                                                    } else {
                                                                      restaurantDetailController.cartDatabaseHelper.insertCartItem(cartModel).then((value) {
                                                                  ...
                                                                  child: Container(
                                                                    ...
                                                                    decoration: BoxDecoration(
                                                                        shape: BoxShape.circle, color: themeChange.isDarkTheme() ? AppThemeData.grey1000 : AppThemeData.grey50),
                                                                    child: Center(
                                                            ...
                                                            Column(
                                                              ...
                                                              children: [
                                                                ...
                                                                TextCustom(
                                                                  title: Constant.amountShow(amount: productModel.price.toString()),
                                                                  fontSize: 14,
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Container(
                                            ...
                                            decoration: BoxDecoration(
                                                borderRadius: BorderRadius.circular(12), color: themeChange.isDarkTheme() ? AppThemeData.secondary600 : AppThemeData.secondary50),
                                            child: Row(
                                              children: [
                                                Image.asset(
                                                ...
                                                spaceW(width: 4),
                                                Expanded(
                                                  child: controller.couponCode.value.isEmpty
                                                      ? Row(
                                                          children: [
                                                            Expanded(
                                                              child: TextCustom(
                                                                title: "Apply coupon code for discount".tr,
                                                                fontSize: 12,
                                                                fontFamily: FontFamily.light,
                                                                maxLine: 2,
                                                                textAlign: TextAlign.start,
                                                          ...
                                                          children: [
                                                            Expanded(
                                                              child: Column(
                                                                ...
                                                                children: [
                                                                  TextCustom(
                                                                    title: controller.selectedCoupon.value.code.toString(),
                                                                    fontSize: 16,
                                                                    fontFamily: FontFamily.medium,
                                                                    maxLine: 2,
                                                                    textAlign: TextAlign.start,
                                                                  ...
                                                                  TextCustom(
                                                                    title: controller.selectedCoupon.value.title.toString(),
                                                                    fontSize: 12,
                                                                    fontFamily: FontFamily.light,
                                                                    maxLine: 2,
                                                                    textAlign: TextAlign.start,
                                                      ...
                                                      children: [
                                                        Radio<String>(
                                                          ...
                                                          onChanged: (value) {
                                                            ...
                                                            controller.calculationOfDeliveryCharge();
                                                          },
                                                        ),
                                                        Text(
                                                          "Home Delivery",
                                                          style: TextStyle(
                                                            ...
                                                            fontFamily: controller.selectedDeliveryType.value == 'home_delivery' ? FontFamily.bold : FontFamily.medium,
                                                          ),
                                                        ),
                                                      ],
                                                    ),
                                                    ...
                                                    child: Row(
                                                      children: [
                                                        ...
                                                        Text(
                                                          ...
                                                          style: TextStyle(
                                                            color: themeChange.isDarkTheme() ? AppThemeData.grey100 : AppThemeData.grey900,
                                                            fontFamily: controller.selectedDeliveryType.value == 'take_away' ? FontFamily.bold : FontFamily.medium,
                                                          ),
                                                        ),
                                                      ],
                                                    ),
                                        ...
                                        children: [
                                          ...
                                          ContainerCustom(
                                            child: Row(
                                              ...
                                              children: [
                                                SvgPicture.asset(
                                                  selectAddressController.selectedAddress.value.addressAs == "Home"
                                                      ? "assets/icons/ic_home2.svg"
                                                      : selectAddressController.selectedAddress.value.addressAs == "Work"
                                                          ? "assets/icons/ic_work.svg"
                                                          : selectAddressController.selectedAddress.value.addressAs == "Friends and Family"
                                                ...
                                                Expanded(
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      TextCustom(
                                                        title: selectAddressController.selectedAddress.value.addressAs.toString(),
                                                        fontSize: 14,
                                                        fontFamily: FontFamily.light,
                                                        textAlign: TextAlign.start,
                                                      ...
                                                      spaceH(height: 2),
                                                      TextCustom(
                                                        title: selectAddressController.selectedAddress.value.address.toString(),
                                                        fontSize: 16,
                                                        fontFamily: FontFamily.medium,
                                                        maxLine: 1,
                                                        textAlign: TextAlign.start,
                                            ...
                                            ContainerCustom(
                                              child: Row(
                                                children: [
                                                  ...
                                                  TextCustom(
                                                    title: controller.selectedPaymentMethod.value.toString(),
                                                    fontSize: 16,
                                                    fontFamily: FontFamily.medium,
                                                    color: themeChange.isDarkTheme() ? AppThemeData.grey100 : AppThemeData.grey900,
                                                  ),
                                    ...
                                    Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          ContainerCustom(
                                            child: Column(
                                              ...
                                              children: [
                                                PriceRowView(
                                                    title: "Item Total".tr,
                                                    price: Constant.amountShow(amount: controller.calculateItemTotal().toString()),
                                                ...
                                                PriceRowView(
                                                    ...
                                                    price: Constant.amountShow(amount: controller.deliveryFee.value.toString()),
                                                    priceColor: AppThemeData.secondary300,
                                                    titleColor: const Color(0xff656565)),
                                                spaceH(height: 12),
                                                PriceRowView(
                                                    title: "Discount".tr,
                                                    price: "-${Constant.amountShow(amount: controller.couponAmount.toString())}",
                                                      ...
                                                      return PriceRowView(
                                                          price: Constant.amountShow(
                                                              amount: Constant.calculateTax(
                                                                      amount: (controller.calculateItemTotal() - controller.couponAmount.value).toString(), taxModel: taxModel)
                                                                  .toString()),
                                                          title:
                                                              "${taxModel.name} (${taxModel.isFix == true ? Constant.amountShow(amount: taxModel.value) : "${taxModel.value}%"})",
                                                          priceColor: themeChange.isDarkTheme() ? AppThemeData.grey100 : AppThemeData.grey900,
                                                          titleColor: const Color(0xff656565));
                                                    }),
                                                Padding(
                                                ...
                                                Row(
                                                  children: [
                                                    TextCustom(
                                                        title: "Total".tr, fontSize: 16, textAlign: TextAlign.start, fontFamily: FontFamily.regular, color: AppThemeData.orange300),
                                                    const Spacer(),
                                                    TextCustom(
                                                      title: Constant.amountShow(amount: controller.calculateFinalAmount().toString()),
                                                      fontSize: 16,
                                                      fontFamily: FontFamily.bold,
                                                      color: AppThemeData.orange300,
                                                    ),
                                          ...
                                          spaceH(height: 4),
                                          TextFieldWidget(title: "Add Delivery Instruction".tr, hintText: "", controller: controller.deliveryInstruction.value, onPress: () {})
                                        ],
                                      ),
                                    )
                                  ],
                        ...
                        ? RoundShapeButton(
                            ...
                            onTap: () async {
                              if (controller.selectedPaymentMethod.value == Constant.paymentModel!.cash!.name) {
                                controller.completeOrder(DateTime.now().millisecondsSinceEpoch.toString(), false);
                              } else if (controller.selectedPaymentMethod.value == Constant.paymentModel!.wallet!.name) {
                                controller.getProfileData();
                                if (double.parse(controller.userModel.value.walletAmount.toString()) >= controller.calculateFinalAmount()) {
                                  ShowToastDialog.showLoader("Please Wait..".tr);
                                  controller.walletPayment();
                                  ShowToastDialog.showToast("Payment successful.".tr);
                                  ShowToastDialog.closeLoader();
                                } else {
                                  ShowToastDialog.showToast("Insufficient Balance in Wallet Amount".tr);
                                }
                              } else if (controller.selectedPaymentMethod.value == Constant.paymentModel!.razorpay!.name) {
                                await controller.razorpayMakePayment(amount: controller.calculateFinalAmount().toString());
                              } else if (controller.selectedPaymentMethod.value == Constant.paymentModel!.payFast!.name) {
                                controller.payFastPayment(context: context, amount: controller.calculateFinalAmount().toString());
                              } else if (controller.selectedPaymentMethod.value == Constant.paymentModel!.payStack!.name) {
                                await controller.payStackPayment(totalAmount: controller.calculateFinalAmount().toString());
                                ...
                                if (Constant.userModel!.email!.isEmpty || Constant.userModel!.email == '') {
                                  ...
                                  await controller.flutterWaveInitiatePayment(context: context, amount: controller.calculateFinalAmount().toString());
                                }
                              } else if (controller.selectedPaymentMethod.value == Constant.paymentModel!.strip!.name) {
                                await controller.stripeMakePayment(amount: controller.calculateFinalAmount().toString());
                              } else if (controller.selectedPaymentMethod.value == Constant.paymentModel!.paypal!.name) {
                                await controller.payPalPayment(amount: controller.calculateFinalAmount().toString());
                              } else if (controller.selectedPaymentMethod.value == Constant.paymentModel!.mercadoPago!.name) {
                                controller.mercadoPagoMakePayment(context: context, amount: controller.calculateFinalAmount().toString());
                              } else if (controller.selectedPaymentMethod.value == Constant.paymentModel!.midtrans!.name) {
                                controller.midtransPayment(context: context, amount: controller.calculateFinalAmount().toString());
                              } else if (controller.selectedPaymentMethod.value == Constant.paymentModel!.xendit!.name) {
                                controller.xenditPayment(context: context, amount: controller.calculateFinalAmount().toString());
                              }
                            },
