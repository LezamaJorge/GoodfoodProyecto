            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  spaceH(height: 4),
                  TextCustom(
                    title: "Add your payment method for seamless transactions.".tr,
                    fontSize: 16,
                    maxLine: 3,
                      ...
                      child: RadioListTile(
                        ...
                        title: Row(
                          ...
                          children: [
                            ...
                            const Spacer(),
                            TextCustom(
                              title: Constant.amountShow(amount: walletController.userModel.value.walletAmount ?? "0.0"),
                              fontSize: 16,
                              fontFamily: FontFamily.medium,
                        ...
                        onChanged: (value) {
                          ...
                          controller.orderModel.value.paymentType = Constant.paymentModel!.wallet!.name;
                        },
                      ),
                    ),
                  ),
          ...
          bottomNavigationBar: Padding(
            ...
            child: RoundShapeButton(
                ...
                onTap: () {
                  ...
                  orderModel.subTotal = controller.calculateItemTotal().toString();
                  orderModel.totalAmount = controller.calculateFinalAmount().toString();
                  orderModel.coupon = controller.selectedCoupon.value;
                  orderModel.discount = controller.couponAmount.value.toString();
                  orderModel.paymentStatus = false;
                  orderModel.taxList = controller.taxList;
                  orderModel.deliveryCharge = controller.deliveryFee.value.toString();
                  orderModel.customerAddress = addressController.selectedAddress.value;
                  orderModel.vendorAddress = controller.restaurantModel.value.address;
                  orderModel.deliveryInstruction = controller.deliveryInstruction.value.text;
                  orderModel.cookingInstruction = controller.cookingInstruction.value.text;
                  orderModel.adminCommission = Constant.adminCommission;
                  orderModel.createdAt = Timestamp.now();
                  orderModel.deliveryType = controller.selectedDeliveryType.value;
                  controller.orderModel.value = OrderModel.fromJson(orderModel.toJson());
                  Get.back();
                },
