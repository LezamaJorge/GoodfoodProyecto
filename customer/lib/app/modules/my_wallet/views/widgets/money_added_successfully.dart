              ...
              decoration: BoxDecoration(
                  gradient: LinearGradient(
                      colors: themeChange.isDarkTheme()
                          ? [const Color(0xffFF780E), const Color(0xffFFA056)]
                          : [const Color(0xffFF790F), const Color(0xffB2530A)],
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          spaceH(height: 4),
                          TextCustom(
                            title: "Your wallet has been successfully topped up with the added funds.",
                            fontSize: 14,
                            maxLine: 4,
