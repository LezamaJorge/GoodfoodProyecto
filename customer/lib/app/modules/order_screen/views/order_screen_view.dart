            ...
            decoration: BoxDecoration(
                gradient: LinearGradient(
                    ...
                    colors: themeChange.isDarkTheme()
                        ? [const Color(0xff1A0B00), const Color(0xff1C1C22)]
                        : [const Color(0xffFFF1E5), const Color(0xffFFFFFF)],
            ...
            child: Scaffold(
              ...
              body: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    buildTopWidget(context, "Orders", "Track your order history and stay updated on your current deliveries."),
                    spaceH(height: 24),
                    SizedBox(
                      height: 45.h,
                      child: ListView(
                      ...
                      child: SingleChildScrollView(
                        child: controller.isLoading.value
                            ...
                            : (controller.selectedOrderType.value == 0
                                ...
                                ? const Center(child: TextCustom(title: "No Orders.."))
                                : ListView.builder(
                                    shrinkWrap: true,
                                          ...
                                          child: ContainerCustom(
                                            child: Column(
                                              children: [
                                                Row(
                                                  ...
                                                  children: [
                                                    Expanded(
                                                      child: TextCustom(
                                                        title:
                                                            "${Constant.timestampToDate(bookingModel.createdAt!)} at ${Constant.timestampToTime12Hour(bookingModel.createdAt!)}",
                                                        fontSize: 14,
                                                ...
                                                Row(
                                                  children: [
                                                    ...
                                                    Container(
                                                      ...
                                                      decoration: BoxDecoration(
                                                          color: OrderStatus.getOrderStatusBackgroundColor(
                                                              bookingModel.orderStatus.toString(), context),
                                                          borderRadius: BorderRadius.circular(4)),
                                                      child: TextCustom(
                                                        title: OrderStatus.getOrderStatusTitle(bookingModel.orderStatus.toString()),
                                                        fontSize: 12,
                                                        fontFamily: FontFamily.medium,
                                                        color: OrderStatus.getOrderStatusTitleColor(
                                                            bookingModel.orderStatus.toString(), context),
                                                      ),
                                                    )
                                                  ],
                                                            ...
                                                            child: Row(
                                                              ...
                                                              children: [
                                                                ...
                                                                Expanded(
                                                                  child: TextCustom(
                                                                    title:
                                                                        "${bookingModel.items![index].quantity}x ${bookingModel.items![index].productName}",
                                                                    fontSize: 14,
                                                                    fontFamily: FontFamily.regular,
                                                                    textAlign: TextAlign.start,
                                                                ...
                                                                TextCustom(
                                                                  title: Constant.amountShow(
                                                                      amount: bookingModel.items![index].totalAmount.toString()),
                                                                  fontSize: 14,
                                                                  fontFamily: FontFamily.regular,
                                                                  color: themeChange.isDarkTheme()
                                                                      ? AppThemeData.grey50
                                                          ...
                                                          Expanded(
                                                              child: RoundShapeButton(
                                                                  ...
                                                                  buttonTextColor: themeChange.isDarkTheme()
                                                                      ...
                                                                      : AppThemeData.grey50,
                                                                  onTap: () {
                                                                    Get.to(const AddReviewScreenView(),
                                                                  ...
                                                                  if (bookingModel.items != null && bookingModel.items!.isNotEmpty) {
                                                                    for (var item in bookingModel.items!) {
                                                                      ...
                                                                      controller.cartDatabaseHelper.insertCartItem(cartModel).then((value) {
                                                                        ShowToastDialog.showToast("Item added to cart.");
                                                                    ...
                                                                    ShowToastDialog.showToast("Reorder placed successfully.");
                                                                    Get.to(const MyCartView());
                                                                  } else {
                                                                    ShowToastDialog.showToast("No past items available for reorder.");
                                                                  }
                                                                },
                                                                size: const Size(0, 52)),
                                                          ),
                                                                          ...
                                                                          return CancelReasonBottomSheet(
                                                                            onConfirm: () async {
                                                                              ...
                                                                              await FirebaseFirestore.instance
                                                                                ...
                                                                                "cancelledReason": trackOrderController.cancelReason[
                                                                                            trackOrderController.selectedIndex.value] !=
                                                                                        "Other"
                                                                                    ? trackOrderController.cancelReason[
                                                                                            trackOrderController.selectedIndex.value]
                                                                                        .toString()
                                                                                ...
                                                                                if (bookingModel.paymentStatus == true) {
                                                                                  WalletTransactionModel transactionModel =
                                                                                      WalletTransactionModel(
                                                                                          ...
                                                                                          paymentType:
                                                                                              bookingModel.paymentStatus.toString(),
                                                                                  ...
                                                                                  await FireStoreUtils.setWalletTransaction(
                                                                                    ...
                                                                                    if (value == true) {
                                                                                      await FireStoreUtils.updateUserWallet(
                                                                                              amount: bookingModel.totalAmount.toString())
                                                                                          .then((value) async {
                                                                                        ...
                                                                                        await SendNotification.sendOneNotification(
                                                                                            ...
                                                                                            body:
                                                                                                'Cancel for this order#${bookingModel.id.toString().substring(0, 5)}',
                                                                                            type: 'order',
                                                                                            orderId: bookingModel.id,
                                                ...
                                                ] else if (bookingModel.orderStatus == OrderStatus.orderCancel ||
                                                    bookingModel.orderStatus == OrderStatus.orderRejected) ...[
                                                  Column(
                                                    children: [
                                                      spaceH(height: 20),
                                                      Row(
                                                ...
                                                ] else if (bookingModel.orderStatus == OrderStatus.driverPickup) ...[
                                                  Column(
                                                    children: [
                                                      spaceH(height: 20),
                                                      RoundShapeButton(
                                              ...
                                              //  bookingModel.orderStatus == OrderStatus.orderPending ?
                                              //   Row(
                                              //     mainAxisSize: MainAxisSize.min,
                                              //     children: [
                                              //       Expanded(
                                              ...
                                              //               title: "Cancel Order".tr,
                                              //               buttonColor:
                                              //                   themeChange.isDarkTheme() ? AppThemeData.grey50 : AppThemeData.grey1000,
                                              //               buttonTextColor:
                                              ...
                                              //                                     .cancelReason[trackOrderController.selectedIndex.value]
                                              //                                     .toString()
                                              //                                 : "${trackOrderController.cancelReason[trackOrderController.selectedIndex.value].toString()} : ${trackOrderController.otherReasonController.value.text}"
                                              //                           }).whenComplete(() {
                                              //                             ShowToastDialog.showToast("Order Cancelled Successfully..");
                                              ...
                                              //               buttonTextColor: AppThemeData.primaryWhite,
                                              //               onTap: () {
                                              //                 Get.toNamed(Routes.TRACK_ORDER, arguments: {"bookingModel": bookingModel});
                                              //               },
                                              //               size: const Size(0, 52))),
                                              //     ],
                                              //   ) :
                                              ...
                                              //                   themeChange.isDarkTheme() ? AppThemeData.grey1000 : AppThemeData.grey50,
                                              //               onTap: () {
                                              //                 Get.toNamed(Routes.ADD_REVIEW_SCREEN,
                                              //                     arguments: {"bookingModel": bookingModel});
                                              //               },
                                              //               size: const Size(0, 52))),
                                              //       spaceW(width: 12),
                                              ...
                                              //     ],
                                              //   ),
                                              // if (bookingModel.orderStatus == OrderStatus.orderCancel)
                                              //   Row(
                                              //     mainAxisSize: MainAxisSize.min,
                                              //     children: [
                                              //       Expanded(
