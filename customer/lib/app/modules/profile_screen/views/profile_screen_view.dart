              ...
              body: SingleChildScrollView(
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      buildTopWidget(context, "My Profile", "Manage your personal information and settings here."),
                      spaceH(height: 32),
                      ...
                      InkWell(
                        ...
                        child: rowWidget(name: "Favourites", icon: "assets/icons/ic_fill_favourite.svg"),
                      ),
                      InkWell(
                        onTap: () {
                          if (FireStoreUtils.getCurrentUid() == null) {
                        ...
                        child: rowWidget(name: "My Address", icon: "assets/icons/ic_map.svg"),
                      ),
                      GestureDetector(
                        onTap: () {
                          if (FireStoreUtils.getCurrentUid() == null) {
                      ...
                      GestureDetector(
                        ...
                        child: rowWidget(name: "Language", icon: "assets/icons/ic_language.svg"),
                      ),
                      FireStoreUtils.getCurrentUid() != null
                          ? GestureDetector(
                              ...
                              child: rowWidget(name: "Logout", icon: "assets/icons/ic_exit.svg", textColor: AppThemeData.danger300),
                            )
                          : GestureDetector(
                              onTap: () {
                                Get.to(LandingScreenView());
                              },
                              child: rowWidget(name: "LogIn", icon: "assets/icons/ic_exit.svg", textColor: AppThemeData.danger300)),
                    ],
                  ),
                ),
              ),
