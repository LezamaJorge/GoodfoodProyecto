            ...
            bottomNavigationBar: Visibility(
                ...
                child: Padding(
                  ...
                  child: RoundShapeButton(
                      title: "View Cart | ${controller.getCartItemCount()} Item".tr,
                                      ...
                                      children: [
                                        Column(
                                          ...
                                          children: [
                                            ...
                                            TextCustom(
                                              title: "Use ${couponModel.code!} above ${Constant.amountShow(amount: couponModel.minAmount)}",
                                              fontSize: 12,
                                              fontFamily: FontFamily.light,
                                              color: AppThemeData.primaryBlack,
                                            ),
                                                                                  ...
                                                                                  InkWell(
                                                                                    onTap: () {
                                                                                      if (int.parse(cartModel.quantity.toString()) >= int.parse(product.maxQuantity.toString())) {
                                                                                        ShowToastDialog.showToast("Max Quantity is ${product.maxQuantity}".tr);
                                                                                      } else {
                                                                                        controller.updateQuantity(cartModel, cartModel.quantity! + 1);
                                                                                      }
                                                                                    },
                    ...
                    child: Obx(
                      () => Row(
                        children: [
                          ...
                          //     child: InkWell(
                          //         onTap: () {
                          //           Share.share("Check out this Restaurant : ${controller.restaurantModel.value.vendorName}\n");
                          //         },
                          //         child: SvgPicture.asset(
