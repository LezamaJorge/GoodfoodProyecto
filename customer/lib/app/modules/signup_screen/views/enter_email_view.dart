...
// import 'package:customer/app/modules/signup_screen/views/enter_mobile_number_view_signup.dart';
...
//
// class EnterEmailScreenView extends GetView<SignupScreenController> {
//   EnterEmailScreenView({super.key});
//
...
//                                 Get.to(EnterMobileNumberScreenViewSignUp());
//
//                                 // controller.sendCode();
//                               } else {
...
//               )),
//           Text("Provide a valid email address for account verification.".tr,
//               style: TextStyle(
//                 fontSize: 16,
