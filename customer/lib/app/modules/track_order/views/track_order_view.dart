                              ...
                              child: ContainerCustom(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    //   decoration: BoxDecoration(
                                    //       color: OrderStatus.getOrderStatusBackgroundColor( controller.bookingModel.value.orderStatus.toString(),
                                    //           context),
                                    //       borderRadius: BorderRadius.circular(4)),
                                    //   child: TextCustom(
                                    //     title: OrderStatus.getOrderStatusTitle(controller.bookingModel.value.orderStatus.toString()),
                                    //     fontSize: 12,
                                    //     fontFamily: FontFamily.medium,
                                    //     color: OrderStatus.getOrderStatusTitleColor(
                                    //         controller.bookingModel.value.orderStatus.toString(), context),
                                    //   ),
                                    // ),
                                    // spaceH(height: 10.h),
                                    Container(
                                    ...
                                    RoundShapeButton(
                                        ...
                                        buttonTextColor: themeChange.isDarkTheme() ? AppThemeData.grey100 : AppThemeData.grey100,
                                        onTap: () {
          ...
          return Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                spaceH(height: 24),
                // TextCustom(
                //     title: 'Arriving in 25 minute...', fontSize: 20, fontFamily: FontFamily.bold, color: themeChange.isDarkTheme() ? AppThemeData.grey50 : AppThemeData.grey1000),
                // spaceH(height: 4),

                if (controller.orderModel.value.orderStatus == OrderStatus.orderPending) ...{
                  const TextCustom(
                    title: 'Assigning a driver to pick it up shortly...',
                    fontSize: 16,
                    ...
                    builder: TimelineTileBuilder.connected(
                      ...
                      connectorBuilder: (context, index, connectorType) {
                        ...
                        if (index == 0) {
                          ...
                          isConnectorActive = controller.orderModel.value.orderStatus == OrderStatus.driverPickup || controller.orderModel.value.orderStatus == OrderStatus.orderComplete;
                        }
                        return SizedBox(
                          width: 25.w,
                ...
                if (controller.orderModel.value.driverId != null)
                  Column(
                    ...
                    children: [
                      spaceH(height: 24),
                      TextCustom(title: 'Driver Assign'.tr, fontSize: 16, fontFamily: FontFamily.medium, color: themeChange.isDarkTheme() ? AppThemeData.grey50 : AppThemeData.grey1000),
                      Container(
                        padding: const EdgeInsets.all(16),
                ...
                //Delivery address
                TextCustom(title: 'Delivery Address'.tr, fontSize: 16, fontFamily: FontFamily.medium, color: themeChange.isDarkTheme() ? AppThemeData.grey50 : AppThemeData.grey1000),
                spaceH(height: 8),
                Container(
                  padding: const EdgeInsets.all(16),
                  decoration: BoxDecoration(borderRadius: BorderRadius.circular(12), color: themeChange.isDarkTheme() ? AppThemeData.surface1000 : AppThemeData.surface50),
                ...
                Container(
                  ...
                  child:
                      // FutureBuilder(
                      //     future: FireStoreUtils.getRestaurant(controller.orderModel.value.restaurantId.toString()),
                      //     builder: (context, snapshot) {
                      //       if (!snapshot.hasData) {
                      //         return Container();
                      //       }
                      //       RestaurantModel restaurant = snapshot.data ?? RestaurantModel();
                      //       return Row(
                      //         children: [
                      //           Expanded(
                      //             child: Row(
