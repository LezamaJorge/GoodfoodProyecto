import 'package:customer/app/modules/add_bank/bindings/add_bank_binding.dart';
import 'package:customer/app/modules/add_bank/views/add_bank_view.dart';
import 'package:customer/app/modules/add_review_screen/bindings/add_review_screen_binding.dart';
import 'package:customer/app/modules/add_review_screen/views/add_review_screen_view.dart';
import 'package:customer/app/modules/all_restaurant_screen/bindings/all_restaurant_screen_binding.dart';
import 'package:customer/app/modules/all_restaurant_screen/views/all_restaurant_screen_view.dart';
import 'package:customer/app/modules/category_restaurant_screen/bindings/category_restaurant_screen_binding.dart';
import 'package:customer/app/modules/category_restaurant_screen/views/category_restaurant_screen_view.dart';
import 'package:customer/app/modules/category_screen/bindings/category_screen_binding.dart';
import 'package:customer/app/modules/category_screen/views/category_screen_view.dart';
import 'package:customer/app/modules/coupon_screen/bindings/coupon_screen_binding.dart';
import 'package:customer/app/modules/coupon_screen/views/coupon_screen_view.dart';
import 'package:customer/app/modules/dashboard_screen/bindings/dashboard_screen_binding.dart';
import 'package:customer/app/modules/dashboard_screen/views/dashboard_screen_view.dart';
import 'package:customer/app/modules/driver_rating_screen/bindings/driver_rating_screen_binding.dart';
import 'package:customer/app/modules/driver_rating_screen/views/driver_rating_screen_view.dart';
import 'package:customer/app/modules/edit_profile_screen/bindings/edit_profile_screen_binding.dart';
import 'package:customer/app/modules/edit_profile_screen/views/edit_profile_screen_view.dart';
import 'package:customer/app/modules/favourites_screen/bindings/favourites_screen_binding.dart';
import 'package:customer/app/modules/favourites_screen/views/favourites_screen_view.dart';
import 'package:customer/app/modules/intro_screen/bindings/intro_screen_binding.dart';
import 'package:customer/app/modules/intro_screen/views/intro_screen_view.dart';
import 'package:customer/app/modules/landing_screen/bindings/landing_screen_binding.dart';
import 'package:customer/app/modules/landing_screen/views/landing_screen_view.dart';
import 'package:customer/app/modules/language_screen/bindings/language_screen_binding.dart';
import 'package:customer/app/modules/language_screen/views/language_screen_view.dart';
import 'package:customer/app/modules/my_address/bindings/my_address_binding.dart';
import 'package:customer/app/modules/my_address/views/my_address_view.dart';
import 'package:customer/app/modules/my_banks/bindings/my_banks_binding.dart';
import 'package:customer/app/modules/my_banks/views/my_banks_view.dart';
import 'package:customer/app/modules/my_cart/bindings/my_cart_binding.dart';
import 'package:customer/app/modules/my_cart/views/my_cart_view.dart';
import 'package:customer/app/modules/my_wallet/bindings/my_wallet_binding.dart';
import 'package:customer/app/modules/my_wallet/views/my_wallet_view.dart';
import 'package:customer/app/modules/notification_screen/bindings/notification_screen_binding.dart';
import 'package:customer/app/modules/notification_screen/views/notification_screen_view.dart';
import 'package:customer/app/modules/order_detail_screen/bindings/order_detail_screen_binding.dart';
import 'package:customer/app/modules/order_detail_screen/views/order_detail_screen_view.dart';
import 'package:customer/app/modules/order_screen/bindings/order_screen_binding.dart';
import 'package:customer/app/modules/order_screen/views/order_screen_view.dart';
import 'package:customer/app/modules/profile_screen/bindings/profile_screen_binding.dart';
import 'package:customer/app/modules/profile_screen/views/profile_screen_view.dart';
import 'package:customer/app/modules/restaurant_detail_screen/bindings/restaurant_detail_screen_binding.dart';
import 'package:customer/app/modules/restaurant_detail_screen/views/restaurant_detail_screen_view.dart';
import 'package:customer/app/modules/search_food_screen/bindings/search_food_screen_binding.dart';
import 'package:customer/app/modules/search_food_screen/views/search_food_view.dart';
import 'package:customer/app/modules/select_address/bindings/select_address_binding.dart';
import 'package:customer/app/modules/select_address/views/select_address_view.dart';
import 'package:customer/app/modules/track_order/bindings/track_order_binding.dart';
...
class AppPages {
  ...
  static final routes = [
    ...
    GetPage(
      name: _Paths.MY_BANKS,
      page: () => const MyBanksView(),
      binding: MyBanksBinding(),
    ),
    GetPage(
    ...
    GetPage(
      name: _Paths.CATEGORY_RESTAURANT,
      page: () => const CategoryRestaurantScreenView(),
      binding: CategoryRestaurantScreenBinding(),
    ),
    GetPage(
