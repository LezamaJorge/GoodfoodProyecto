                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        TextCustom(
                                          title: controller.selectedTimeRevenue.value == 'Monthly'
                                              ? controller.totalEarning.value.toString()
                                              : controller.weeklyEarning.value.toString(),
                                          fontSize: 12,
                                        ...
                                        spaceW(width: 4.w),
                                        TextCustom(title: 'From Last ${controller.selectedTimeRevenue.value}')
                                      ],
                                    )
                                  ],
                                ),
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        spaceW(width: 4.w),
                                        TextCustom(title: 'From Last ${controller.selectedTimeTotalOrders.value}')
                                      ],
                                    )
                                  ],
                                ),
