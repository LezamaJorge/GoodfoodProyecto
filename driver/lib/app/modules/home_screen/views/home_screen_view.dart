                            ...
                            controller.driverStatus.value
                                ? controller.isOrderDataLoading.value == true
                                    ...
                                    : controller.driverUserModel.value.orderId != null && controller.driverUserModel.value.orderId != ''
                                        ? controller.orderModel.value.orderStatus == OrderStatus.driverAssigned || controller.orderModel.value.orderStatus == OrderStatus.orderPending
                                            ? NewOrderWidget()
                                            : controller.orderModel.value.orderStatus == OrderStatus.driverAccepted || controller.orderModel.value.orderStatus == OrderStatus.orderOnReady
                                                ? ContainerCustom(
                                                    ...
                                                    child: Column(
                                                      ...
                                                      children: [
                                                        Row(
                                                          children: [
                                                            TextCustom(
                                                              title: 'Your Location To Drop Point: ',
                                                              fontSize: 14,
                                                              fontWeight: FontWeight.w400,
                                                            ),
                                                            TextCustom(
                                      ...
                                      children: [
                                        ...
                                        const Column(
                                          ...
                                          children: [
                                            ...
                                            FittedBox(
                                              child: TextCustom(
                                                title: 'Go online to begin accepting new orders.',
                                                fontSize: 13,
                                                fontWeight: FontWeight.w400,
                                                color: AppThemeData.grey600,
                                              ),
                    ...
                    controller.orderModel.value.foodIsReadyToPickup == false
                        ...
                        : Column(
                            ...
                            children: [
                              ...
                              TextCustom(
                                title: 'ID ${controller.orderModel.value.id!.substring(0, 4)}',
                                fontSize: 14,
                                textAlign: TextAlign.start,
                                fontWeight: FontWeight.w400,
                                maxLine: 3,
