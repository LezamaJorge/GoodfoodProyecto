        ...
        if (value.additionalUserInfo!.isNewUser) {
          ...
          if (userExist) {
            ...
            if (driverModel != null) {
              ...
              ShowToastDialog.showToast("This Account doesn't match with this app");
            }
          } else {
            String fcmToken = await NotificationService.getToken();
            DriverUserModel driverModel = DriverUserModel();
  ...
  Future<void> emailSignIn() async {
    try {
      ...
      if (userCredential != null) {
        DriverUserModel? driverModel = await FireStoreUtils.getDriverProfile(FireStoreUtils.getCurrentUid());
