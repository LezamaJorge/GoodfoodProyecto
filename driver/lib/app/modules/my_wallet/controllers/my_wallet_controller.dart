...
import 'package:driver/app/models/transaction_log_model.dart';import 'package:driver/app/models/wallet_transaction_model.dart';
...
class MyWalletController extends GetxController {
  ...
  Rx<DriverUserModel> ownerModel = DriverUserModel().obs;
  ...
  void generateDefaultAmounts() {
    try {
      int baseAmount = int.parse(Constant.minimumAmountToDeposit);
      addMoneyTagList.value = [1, 2, 3, 5, 10]
          .map((multiplier) => (baseAmount * multiplier).toString())
          .toList();
    } catch (e,stack) {
      developer.log("Error to generate deposit amounts", error: e, stackTrace: stack);
  ...
  void generateDefaultAmountsForWithdraw() {
    try {
      int baseAmount = int.parse(Constant.minimumAmountToWithdrawal);
      withdrawMoneyTagList.value = [1, 2, 3, 5, 10]
          .map((multiplier) => (baseAmount * multiplier).toString())
          .toList();
    } catch (e,stack) {
...
// :::::::::::::::::::::::::::::::::::::::::::: Xendit ::::::::::::::::::::::::::::::::::::::::::::::::::::
  ...
  Future<XenditModel?> createXenditInvoice({required num amount}) async {
    ...
    final body = jsonEncode({
      ...
      'amount': amount,
      'payer_email': ownerModel.value.email.toString(),
...
// :::::::::::::::::::::::::::::::::::::::::::: MidTrans ::::::::::::::::::::::::::::::::::::::::::::::::::::
  ...
  Future<void> midtransPayment({required BuildContext context, required String amount}) async {
    final url = await createMidtransPaymentLink(
      ...
      customerEmail: ownerModel.value.email.toString(),
    );
