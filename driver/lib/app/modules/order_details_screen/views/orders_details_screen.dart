                                    ...
                                    children: [
                                      ...
                                      ContainerCustomSub(
                                        child: Column(
                                          ...
                                          children: [
                                            // PriceRowView(
                                            //     title: "Item Total".tr,
                                            //     price: Constant.amountShow(amount: '741'),
                                            ...
                                            // PriceRowView(
                                            //     title: "Discount".tr,
                                            //     price: Constant.amountShow(amount: "00"),
                                            //     // controller.bookingModel.value.discount == "" || controller.bookingModel.value.discount == null
                                            //     //     ? Constant.amountShow(amount: "00")
                                            //     //     : Constant.amountShow(amount: controller.bookingModel.value.discount.toString()),
                                            //     priceColor: themeChange.isDarkTheme() ? AppThemeData.success200 : AppThemeData.success400,
                                            //     titleColor: const Color(0xff656565)),
                                            // spaceH(height: 12),
                                            // PriceRowView(
                                            //     title: "GST".tr,
                                            //     // price: controller.bookingModel.value.adminCommission!.value.toString(),
                                            //     price: Constant.amountShow(amount: "785"),
                                            //     priceColor: themeChange.isDarkTheme() ? AppThemeData.grey100 : AppThemeData.grey900,
                                            //     titleColor: const Color(0xff656565)),
                                            // Padding(
                                      ...
                                      ContainerCustomSub(
                                        alignment: Alignment.topLeft,
                                          child:  controller.reviewModel.value.comment != null && controller.reviewModel.value.comment!.isNotEmpty ? Column(
                                            crossAxisAlignment: CrossAxisAlignment.start,
                                          children: [
                                            RatingBar.builder(
                                                glow: false,
