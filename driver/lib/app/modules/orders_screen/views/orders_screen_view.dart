                        ...
                        (index) {
                          return GestureDetector(
                            onTap: () {
                              ...
                              // if (controller.selectedTags.value == "New Order") {
                              //   // controller.filterOrderList.value = controller.preparingOrderList;
                        ...
                        ? Constant.isDriverOnline.value
                            ? controller.isLoading.value == true
                                ...
                                : (controller.driverUserModel.value.orderId == null ||
                                    ...
                                    ? Center(child: TextCustom(title: "No New Order Found"))
                                    : NewOrderWidget()
