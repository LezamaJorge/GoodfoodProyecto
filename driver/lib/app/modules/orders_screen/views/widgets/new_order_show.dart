          ...
          child: Column(
            children: [
              ...
              Row(
                children: [
                  TextCustom(
                    title: 'Your Location To Pickup Point: ',
                    fontSize: 14,
                    fontWeight: FontWeight.w400,
                  ),
                  TextCustom(
              ...
              if (controller.orderModel.value.orderStatus == 'driver_assigned' || controller.orderModel.value.orderStatus == 'order_pending')
                Row(
                  ...
                  children: [
                    ...
                    RoundShapeButton(
                        size: Size(157.w, ScreenSize.height(6, context)),
                        title: "Accept in ${controller.formatSeconds(controller.remainingSeconds.value)}".tr,
                        ...
                        onTap: () {
                          if (controller.orderModel.value.paymentStatus != true) {
                            ...
                            if (walletAmount < orderAmount) {
                              return ShowToastDialog.showToast("'Not enough balance in your wallet. Minimum amount is \$${orderAmount.toStringAsFixed(2)}.'");
                            }
                          } else {
...
void orderIsReadyBottomSheet(BuildContext context, OrdersScreenController controller, DarkThemeProvider themeChange) {
  ...
  showModalBottomSheet(
      ...
      builder: (context) {
        ...
        //   child: TextCustom(title: 'Open BottomSheet'),
        // );
