        ...
        Obx(() => Column(
              ...
              children: [
                TextFieldWidget(
                  ...
                  onPress: () {},
                  readOnly:
                      (controller.driverModel.value.loginType == Constant.googleLoginType || controller.driverModel.value.loginType == Constant.appleLoginType) ? true : false,
                ),
              ],
            )
        ),
              ...
              Obx(() => TextFieldWidget(
                    ...
                    validator: (value) {
                      if (value == null || value.isEmpty) {
                        return "Confirm password is required.".tr; // Or a more specific "This field is required" message
                      }
                      if (value != controller.passwordController.value.text) {
                        return "Passwords do not match.".tr; // Message when passwords don't match
                      }
                    },
