...
class UploadDocumentView extends GetView<SignupScreenController> {
  const UploadDocumentView({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final themeChange = Provider.of<DarkThemeProvider>(context);
    log('=======> in upload document ${controller.verifyDocumentList.length}');
    return GetX(
                                                      ...
                                                      RoundShapeButton(
                                                        ...
                                                        onTap: () {
                                                          controller.documentPickFile(
                                                              source: ImageSource.gallery, verifyDocumentModel: documentModel, index: index, imageIndex: 1);
                                                        },
                                                        size: Size(140.w, 46.h),
                                                      ),
                                                    ],
                  ...
                  RoundShapeButton(
                    ...
                    onTap: () async {
                      if (areImagesUploaded) {
                        ...
                        ShowToastDialog.showToast("Upload required legal document images".tr);
                      }
                    },
