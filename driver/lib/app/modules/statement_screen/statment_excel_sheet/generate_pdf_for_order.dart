...
Future<void> generateOrdersExcelSheet(List<OrderModel> orderList, DateTimeRange selectedRange) async {
  try {
    if (orderList.isEmpty) {
      ShowToastDialog.showToast('No data found for the selected date range.');
      return;
    }
    ...
    if (fileBytes != null) {
      ...
      final String filePath =
          '${directory.path}/Order_Bookings_${formattedStartDate}_to_$formattedEndDate.xlsx';
    ...
    ShowToastDialog.showToast("Failed to generate report. Please try again.");
  }
}
