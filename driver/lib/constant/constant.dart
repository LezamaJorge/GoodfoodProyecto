...
import 'package:driver/app/models/handyman_model.dart';
import 'package:driver/app/models/provider_model.dart';
...
class Constant {
  static ProviderModel? providerModel;
  ...
  static String fullNameString(String? firstName, String? lastName) {
    try {
      ...
      developer.log("Error in fullNameString", error: e, stackTrace: stack);
      return '';
    }
  }
