...
class AppThemeData {
  ...
  static const Color darkBackGroundColor = Color(0xff1C1C22);

  static const Color gallery = Color(0xffF8F8F8);
  static const Color gallery50 = Color(0xFFF8F8F8);
  static const Color gallery100 = Color(0xFFEDEDED);
  static const Color gallery200 = Color(0xFFDCDCDC);
  static const Color gallery300 = Color(0xFFBDBDBD);
  static const Color gallery400 = Color(0xff989898);
  static const Color gallery500 = Color(0xff7C7C7C);
  static const Color gallery600 = Color(0xff656565);
  static const Color gallery700 = Color(0xff525252);
  static const Color gallery800 = Color(0xff464646);
  static const Color gallery900 = Color(0xff3D3D3D);
  static const Color gallery950 = Color(0xFF292929);

  static const Color primaryGreen = Color(0xFF47B800);

  static Color primary = const Color(0xff7F00FF);
  static Color violet700 = const Color(0xFF7F00FF);
  static const Color violet500 = Color(0xFF933BFF);
  static const Color violet400 = Color(0xFFAA73FF);
  static const Color violet200 = Color(0xFFF5F0FF);
  ...
  static const ratingBarColor = Color(0xffFFD622);
  static const Color yellow04 = Color(0xffFFC844);
  static const Color yellow600 = Color(0xffD1BF00);

  static const Color green04 = Color(0xff2EC39E);
  static const Color orange = Color(0xffFF3C26);
  static const Color green600 = Color(0xff00B800);
  static const Color green700 = Color(0xff368B00);
  static const Color flamenco400 = Color(0xffFFAF32);
  static const Color flamenco800 = Color(0xffA1460B);
  static const Color flamenco700 = Color(0xffCC5A02);

  static const Color thunderBird600 = Color(0xffFC1F06);
  static const Color thunderBird50 = Color(0xffFFF2F0);
  ...
  static const Color primary600 = Color(0xff01190B);
  static const Color primary500 = Color(0xff025024);
  static const Color primary400 = Color(0xff03873D);
  static Color primary300 = const Color(0xff04BF55);
  static const Color primary200 = Color(0xff4FD489);
  static const Color primary100 = Color(0xff9AE9BD);
  static const Color primary50 =  Color(0xffE6FEF1);
  ...
  static const Color black01 = Color(0xff1F1F1F);
