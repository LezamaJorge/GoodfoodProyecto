...
class FireStoreUtils {
  ...
  static Future<bool> userExistOrNot(String uid) async {
    ...
    try {
      final doc = await fireStore.collection(CollectionName.driver).doc(uid).get();
      isExist = doc.exists;
    } catch (e, stack) {
  ...
  static Future<DriverUserModel?> getDriverProfile(String uuid) async {
    try {
      ...
      developer.log("Error in getDriverProfile", error: error, stackTrace: stack);
      return null;
    }
  }
  ...
  static Future<bool?> setWalletTransaction(WalletTransactionModel walletTransactionModel) async {
    ...
    try {
      ...
      developer.log("Error in setWalletTransaction", error: e, stackTrace: stack);
      isAdded = false;
    }
    return isAdded;
  }
  ...
  static Future<bool?> updateDriverWallet({required String amount}) async {
    ...
    try {
      final driverProfile = await getDriverProfile(FireStoreUtils.getCurrentUid());
      ...
      if (driverProfile != null) {
        ...
        isAdded = await FireStoreUtils.updateDriverUserProfile(ownerModel);
      }
    } catch (e, stack) {
  ...
  static Future<bool> updateOwner(OwnerModel ownerModel) async {
    ...
    try {
      await fireStore.collection(CollectionName.owner).doc(ownerModel.id).update(ownerModel.toJson());
  ...
  static Future<bool> updateVerifyDriver(VerifyDriverModel driverModel) async {
    ...
    try {
      await fireStore.collection(CollectionName.verifyDriver).doc(driverModel.driverId).update(driverModel.toJson());
  ...
  static Future<VerifyDriverModel?> getDocuments() async {
    ...
    try {
      final docSnapshot = await fireStore.collection(CollectionName.verifyDriver).doc(FireStoreUtils.getCurrentUid()).get();
  ...
  static Future<DriverUserModel?> getDriverUserProfile(String uuid) async {
    ...
    try {
      ...
      developer.log("Error in getDriverUserProfile", error: e, stackTrace: stack);
  ...
  static Future<bool> updateDriverUserProfile(DriverUserModel driverUserModel) async {
    bool isUpdate = false;
    ...
    try {
      ...
      developer.log("Error in updateDriverUserProfile", error: e, stackTrace: stack);
      isUpdate = false;
    }
  ...
  static Future<bool> updateDriverUser(DriverUserModel handymanModel) async {
    bool isUpdate = false;

    try {
      await fireStore.collection(CollectionName.driver).doc(handymanModel.driverId).update(handymanModel.toJson());

      isUpdate = true;
    } catch (e, stack) {
      developer.log("Error in updateDriverUser", error: e, stackTrace: stack);
      isUpdate = false;
    }
  ...
  Future<PaymentModel?> getPayment() async {
    ...
    try {
      final docSnapshot = await fireStore.collection(CollectionName.settings).doc("payment").get();
  ...
  static Future<List<BankDetailsModel>?> getBankDetailList(String? ownerId) async {
    ...
    try {
      final querySnapshot = await fireStore.collection(CollectionName.bankDetails).where("driverId", isEqualTo: ownerId).get();
  ...
  static Future<List<WalletTransactionModel>?> getWalletTransaction() async {
    ...
    try {
      ...
      developer.log("Error in getWalletTransaction", error: e, stackTrace: stack);
      return null;
    }
  ...
  static Future<List<OrderModel>> getOrderListForStatement(DateTimeRange? dateTimeRange) async {
    ...
    try {
      ...
      developer.log("Error in getOrderListForStatement", error: e, stackTrace: stack);
    }
  ...
  static Future<List<OrderModel>?> getRejectsOrder() async {
    ...
    try {
      final querySnapshot =
          await fireStore.collection(CollectionName.orders).where('rejectedDriverIds', arrayContains: FireStoreUtils.getCurrentUid()).orderBy('createdAt', descending: true).get();
  ...
  static Future<List<LanguageModel>?> getLanguage() async {
    ...
    try {
      final querySnapshot = await fireStore.collection(CollectionName.languages).where('active', isEqualTo: true).get();
  ...
  static Future<ReviewModel?> getReview(String orderId) async {
    ...
    try {
      final docSnapshot = await fireStore.collection(CollectionName.review).doc(orderId).get();
  ...
  static Future<List<dynamic>> getRejectOrderReason() async {
    try {
      final doc = await fireStore.collection(CollectionName.settings).doc('driver_reject_reason').get();
      ...
      developer.log("Error in getRejectOrderReason", error: e, stackTrace: stack);
      return [];
    }
  }
  ...
  static Future<List<DocumentModel>?> getDocumentsList() async {
    ...
    try {
      final querySnapshot = await fireStore.collection(CollectionName.documents).where('type', isEqualTo: 'Driver').where('active', isEqualTo: true).get();
  ...
  Future<void> getSettings() async {
    try {
      ...
      if (constantDoc.exists) {
        ...
        Constant.isDriverDocumentVerification = data["isDriverDocumentVerification"];
      }
    } catch (e, stack) {
    ...
    try {
      final commissionDoc = await fireStore.collection(CollectionName.settings).doc("admin_commission").get();
      Constant.adminCommission = AdminCommission.fromJson(commissionDoc.data()!);
    } catch (e, stack) {
      developer.log("Error in getAdminCommission", error: e, stackTrace: stack);
    }

    try {
      final statusDoc = await fireStore.collection(CollectionName.settings).doc("status").get();
  ...
  static Stream<QuerySnapshot> getNotificationList() {
    try {
      ...
      return fireStore.collection(CollectionName.notification).where('driverId', isEqualTo: uid).orderBy('createdAt', descending: true).snapshots();
    } catch (e, stack) {
      developer.log("Error in getNotificationList", error: e, stackTrace: stack);
  ...
  Stream<DriverUserModel?> getServiceNearestByFeatured({double? latitude, double? longLatitude}) async* {
    getNearestServiceRequestController = StreamController<DriverUserModel?>.broadcast();

    try {
      Query query = fireStore.collection(CollectionName.driver).where("isOnline", isEqualTo: true).where("active", isEqualTo: true);
      ...
      Stream<List<DocumentSnapshot>> stream = GeoFlutterFire().collection(collectionRef: query).within(
            center: center,
      ...
      developer.log("Error in getServiceNearestByFeatured", error: e, stackTrace: stack);
      getNearestServiceRequestController.sink.add(null);
    }
  ...
  static Future<VendorModel?> getRestaurant(String uuid) async {
    ...
    try {
      final doc = await fireStore.collection(CollectionName.vendors).doc(uuid).get();
      if (doc.exists) {
  ...
  static Future<CustomerUserModel?> getCustomerUserData(String uuid) async {
    ...
    try {
      final doc = await fireStore.collection(CollectionName.customers).doc(uuid).get();
      if (doc.exists) {
        userModel = CustomerUserModel.fromJson(doc.data()!);
      }
    } catch (error, stack) {
      developer.log("Error in getCustomerUserData", error: error, stackTrace: stack);
      userModel = null;
    }
  ...
  Stream<List<OrderModel>> getNewOrder() async* {
    try {
      final snapshots = fireStore.collection(CollectionName.orders).where('orderStatus', whereIn: [OrderStatus.orderAccepted]).orderBy('createdAt', descending: true).snapshots();
  ...
  static Future<List<ReviewModel>?> getDriverReview(String driverId) async {
    ...
    try {
      final snapshot = await fireStore.collection(CollectionName.review).where("driverId", isEqualTo: driverId).where('type', isEqualTo: Constant.driver).get();
  ...
  static Future<List<OnboardingScreenModel>> getOnboardingDataList() async {
    ...
    try {
      var snapshot = await fireStore.collection(CollectionName.onboardingScreen).where('status', isEqualTo: true).where('type', isEqualTo: 'driver').orderBy('createdAt', descending: false).get();
      for (var element in snapshot.docs) {
