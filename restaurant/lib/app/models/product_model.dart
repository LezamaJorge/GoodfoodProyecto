...
class ProductModel {
  ...
  @override
  String toString() {
    return 'ProductModel{id: $id, vendorId: $vendorId, productName: $productName, categoryId: $categoryId, categoryModel: $categoryModel, subCategoryId: $subCategoryId, subCategoryModel: $subCategoryModel, foodType: $foodType, discountType: $discountType, status: $status, inStock: $inStock, price: $price, discount: $discount, description: $description, createAt: $createAt, productImage: $productImage, addonsList: $addonsList, variationList: $variationList, likedUser: $likedUser, tagsList: $itemTag, reviewSum: $reviewSum, reviewCount: $reviewCount}';
  }
