            ...
            children: [
                ...
                children: [
                  Expanded(
                    child: RoundShapeButton(
                      ...
                      buttonTextColor: AppThemeData.grey100,
                      onTap: () async {
                        if (controller.resetEmailController.value.text.isNotEmpty) {
                          await controller.resetPassword(controller.resetEmailController.value.text).then((value) {
                            ...
                            ShowToastDialog.toast("Reset password link sent successfully.".tr);
                          ...
                          ShowToastDialog.toast('Please enter a valid email address.'.tr);
                        }
                      },
              ...
              GestureDetector(
                ...
                child: Text(
                  "Back to Sign In".tr,
                  style: TextStyle(
                      fontFamily: FontFamily.regular, color: themeChange.isDarkTheme() ? AppThemeData.grey100 : AppThemeData.grey1000, decoration: TextDecoration.underline),
