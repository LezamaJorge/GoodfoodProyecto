              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    spaceH(height: 4.h),
                    TextCustom(
                      title: 'Min. Withdrawal amount will be a ${Constant.amountShow(amount: Constant.minimumAmountToWithdrawal)}',
                      fontSize: 14,
                      ...
                      child: RoundShapeButton(
                        ...
                        onTap: () async {
                          ...
                          if (enteredAmount < minimumAmount) {
                            return ShowToastDialog.toast("Minimum withdrawal amount is $minimumAmount".tr);
                          }

                          if (controller.withdrawalNoteController.value.text.isEmpty) {
                            return ShowToastDialog.toast("Please enter a note.".tr);
                          }
                          if (double.parse(controller.ownerModel.value.walletAmount.toString()) <= double.parse(Constant.minimumAmountToWithdrawal.toString())) {
                            ShowToastDialog.toast("Insufficient wallet balance.".tr);
                          } else {
                            ShowToastDialog.showLoader("Please Wait..".tr);
                            if (controller.withdrawalAmountController.value.text.isEmpty) {
                              ShowToastDialog.toast("Please enter an amount to proceed.".tr);
                            } else if (double.parse(controller.ownerModel.value.walletAmount.toString()) < double.parse(controller.withdrawalAmountController.value.text)) {
                              ShowToastDialog.toast("Insufficient wallet balance.".tr);
                              ...
                              await FireStoreUtils.updateOwnerWallet(amount: "-${controller.withdrawalAmountController.value.text}", ownerID: Constant.ownerModel!.id.toString());
                              ...
                              await FireStoreUtils.setWithdrawRequest(withdrawModel).then((value) {
                                ...
                                ShowToastDialog.toast("Withdrawal request sent to admin.".tr);
